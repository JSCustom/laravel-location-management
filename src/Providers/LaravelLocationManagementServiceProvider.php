...
namespace JSCustom\LaravelLocationManagement\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Facades\Route;

class LaravelLocationManagementServiceProvider extends ServiceProvider
{
    ...
    protected function routeConfiguration()
    {
        return [
            ...
            'middleware' => config('location.middleware'),
        ];
    }
